...
(function (a, b) {
    ...
    var H = a.document, I = a.navigator, J = a.location, K = function () {
        ...
        }), z = d.uaMatch(y), z.browser && (d.browser[z.browser] = !0, d.browser.version = z.version), d.browser.webkit && (d.browser.safari = !0), i.test("聽") && (j = /^[\s\xA0]+/, k = /[\s\xA0]+$/), g = d(H), H.addEventListener ? B = function () {
