...
public class IpUtils {
    ...
    public static int[] getIPIntScope(String ipAndMask) {
        ...
        int ipInt = IpUtils.ipToInt(ipArr[0]);
    ...
    public static String[] getIPAddrScope(String ipAndMask) {
        int[] ipIntArr = IpUtils.getIPIntScope(ipAndMask);
        return new String[]{IpUtils.intToIp(ipIntArr[0]),
                IpUtils.intToIp(ipIntArr[0])};
    }
    ...
    public static int[] getIPIntScope(String ipAddr, String mask) {
        ...
        try {
            ipInt = IpUtils.ipToInt(ipAddr);
            if (null == mask || "".equals(mask)) {
                return new int[]{ipInt, ipInt};
            }
            netMaskInt = IpUtils.ipToInt(mask);
            ipcount = IpUtils.ipToInt("255.255.255.255") - netMaskInt;
    ...
    public static String[] getIPStrScope(String ipAddr, String mask) {
        int[] ipIntArr = IpUtils.getIPIntScope(ipAddr, mask);
        return new String[]{IpUtils.intToIp(ipIntArr[0]),
                IpUtils.intToIp(ipIntArr[0])};
    }
    ...
    public static void main1(String[] args) throws Exception {
        ...
        byte[] bytearr = IpUtils.ipToBytesByInet(ipAddr);
        ...
        bytearr = IpUtils.ipToBytesByReg(ipAddr);
